  ...
  return (
    <div className='flex flex-col justify-end max-w-screen h-screen bg-bg mx-auto overflow-x-hidden px-4 md:px-16 lg:px-24 xl:px-32 bg-[url("/hero_bg.png")] bg-center bg-cover'>
        ...
        <div className='flex flex-col items-start pb-4 gap-2'>
            ...
            <p data-aos="fade-right" data-aos-delay="100" className='text-sm text-gray-300 md:w-2xl'>Choose from a wide range of well maintained vehicles at affordable prices. Quick booking, transparent pricing and 24/7 support wherever you go.</p>
        </div>
